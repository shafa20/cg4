...
<body>
  <div class="container mt-5">
    <form method="post" id="update_user" name="update_user" enctype="multipart/form-data" action="<?= site_url('/update') ?>">
      ...
      <div class="form-group">
        ...
        <?php if (!empty ($user_obj['profile_pic'])): ?>
          <img src="<?php echo base_url('uploads/' . $user_obj['profile_pic']); ?>" width="100" height="100"
